...
// ByClaims orders the results by the claims field.
func ByClaims(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldClaims, opts...).ToFunc()
}
