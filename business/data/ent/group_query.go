...
func (gq *GroupQuery) QueryAuthUsersGroups() *UsersGroupsQuery {
	query := (&UsersGroupsClient{config: gq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := gq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (gq *GroupQuery) Clone() *GroupQuery {
	...
	return &GroupQuery{
		...
		withAuthUsersGroups: gq.withAuthUsersGroups.Clone(),
...
func (gq *GroupQuery) WithAuthUsersGroups(opts ...func(*UsersGroupsQuery)) *GroupQuery {
	query := (&UsersGroupsClient{config: gq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	gq.withAuthUsersGroups = query
	return gq
}
...
func (gq *GroupQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Group, error) {
	...
	if query := gq.withAuthUsersGroups; query != nil {
		if err := gq.loadAuthUsersGroups(ctx, query, nodes,
			func(n *Group) { n.Edges.AuthUsersGroups = []*UsersGroups{} },
			func(n *Group, e *UsersGroups) { n.Edges.AuthUsersGroups = append(n.Edges.AuthUsersGroups, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (gq *GroupQuery) loadAuthUsersGroups(ctx context.Context, query *UsersGroupsQuery, nodes []*Group, init func(*Group), assign func(*Group, *UsersGroups)) error {
	...
	query.Where(predicate.UsersGroups(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(group.AuthUsersGroupsColumn), fks...))
	}))
