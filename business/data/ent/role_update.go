...
func (ru *RoleUpdate) AddAuthUsersRoleIDs(ids ...int) *RoleUpdate {
	ru.mutation.AddAuthUsersRoleIDs(ids...)
	return ru
}

// AddAuthUsersRoles adds the "auth_users_roles" edges to the UsersRoles entity.
func (ru *RoleUpdate) AddAuthUsersRoles(u ...*UsersRoles) *RoleUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return ru.AddAuthUsersRoleIDs(ids...)
}
...
func (ru *RoleUpdate) ClearAuthUsersRoles() *RoleUpdate {
	ru.mutation.ClearAuthUsersRoles()
	return ru
}

// RemoveAuthUsersRoleIDs removes the "auth_users_roles" edge to UsersRoles entities by IDs.
func (ru *RoleUpdate) RemoveAuthUsersRoleIDs(ids ...int) *RoleUpdate {
	ru.mutation.RemoveAuthUsersRoleIDs(ids...)
	return ru
}

// RemoveAuthUsersRoles removes "auth_users_roles" edges to UsersRoles entities.
func (ru *RoleUpdate) RemoveAuthUsersRoles(u ...*UsersRoles) *RoleUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return ru.RemoveAuthUsersRoleIDs(ids...)
}
...
func (ru *RoleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if ru.mutation.UsersCleared() {
		...
		createE := &UsersRolesCreate{config: ru.config, mutation: newUsersRolesMutation(ru.config, OpCreate)}
		createE.defaults()
	...
	if ru.mutation.AuthUsersRolesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   role.AuthUsersRolesTable,
			Columns: []string{role.AuthUsersRolesColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := ru.mutation.RemovedAuthUsersRolesIDs(); len(nodes) > 0 && !ru.mutation.AuthUsersRolesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   role.AuthUsersRolesTable,
	...
	if nodes := ru.mutation.AuthUsersRolesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   role.AuthUsersRolesTable,
...
// AddAuthUsersRoleIDs adds the "auth_users_roles" edge to the UsersRoles entity by IDs.
func (ruo *RoleUpdateOne) AddAuthUsersRoleIDs(ids ...int) *RoleUpdateOne {
	ruo.mutation.AddAuthUsersRoleIDs(ids...)
	return ruo
}

// AddAuthUsersRoles adds the "auth_users_roles" edges to the UsersRoles entity.
func (ruo *RoleUpdateOne) AddAuthUsersRoles(u ...*UsersRoles) *RoleUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return ruo.AddAuthUsersRoleIDs(ids...)
}
...
// ClearAuthUsersRoles clears all "auth_users_roles" edges to the UsersRoles entity.
func (ruo *RoleUpdateOne) ClearAuthUsersRoles() *RoleUpdateOne {
	ruo.mutation.ClearAuthUsersRoles()
	return ruo
}

// RemoveAuthUsersRoleIDs removes the "auth_users_roles" edge to UsersRoles entities by IDs.
func (ruo *RoleUpdateOne) RemoveAuthUsersRoleIDs(ids ...int) *RoleUpdateOne {
	ruo.mutation.RemoveAuthUsersRoleIDs(ids...)
	return ruo
}

// RemoveAuthUsersRoles removes "auth_users_roles" edges to UsersRoles entities.
func (ruo *RoleUpdateOne) RemoveAuthUsersRoles(u ...*UsersRoles) *RoleUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return ruo.RemoveAuthUsersRoleIDs(ids...)
}
...
func (ruo *RoleUpdateOne) sqlSave(ctx context.Context) (_node *Role, err error) {
	...
	if ruo.mutation.UsersCleared() {
		...
		createE := &UsersRolesCreate{config: ruo.config, mutation: newUsersRolesMutation(ruo.config, OpCreate)}
		createE.defaults()
		_, specE := createE.createSpec()
		edge.Target.Fields = specE.Fields
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	...
	if ruo.mutation.AuthUsersRolesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   role.AuthUsersRolesTable,
	...
	if nodes := ruo.mutation.RemovedAuthUsersRolesIDs(); len(nodes) > 0 && !ruo.mutation.AuthUsersRolesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   role.AuthUsersRolesTable,
	...
	if nodes := ruo.mutation.AuthUsersRolesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   role.AuthUsersRolesTable,
