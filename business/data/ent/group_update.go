...
func (gu *GroupUpdate) AddAuthUsersGroupIDs(ids ...int) *GroupUpdate {
	gu.mutation.AddAuthUsersGroupIDs(ids...)
	return gu
}

// AddAuthUsersGroups adds the "auth_users_groups" edges to the UsersGroups entity.
func (gu *GroupUpdate) AddAuthUsersGroups(u ...*UsersGroups) *GroupUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return gu.AddAuthUsersGroupIDs(ids...)
}
...
func (gu *GroupUpdate) ClearAuthUsersGroups() *GroupUpdate {
	gu.mutation.ClearAuthUsersGroups()
	return gu
}

// RemoveAuthUsersGroupIDs removes the "auth_users_groups" edge to UsersGroups entities by IDs.
func (gu *GroupUpdate) RemoveAuthUsersGroupIDs(ids ...int) *GroupUpdate {
	gu.mutation.RemoveAuthUsersGroupIDs(ids...)
	return gu
}

// RemoveAuthUsersGroups removes "auth_users_groups" edges to UsersGroups entities.
func (gu *GroupUpdate) RemoveAuthUsersGroups(u ...*UsersGroups) *GroupUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return gu.RemoveAuthUsersGroupIDs(ids...)
}
...
func (gu *GroupUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if gu.mutation.UsersCleared() {
		...
		createE := &UsersGroupsCreate{config: gu.config, mutation: newUsersGroupsMutation(gu.config, OpCreate)}
		createE.defaults()
	...
	if gu.mutation.AuthUsersGroupsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
	...
	if nodes := gu.mutation.RemovedAuthUsersGroupsIDs(); len(nodes) > 0 && !gu.mutation.AuthUsersGroupsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   group.AuthUsersGroupsTable,
	...
	if nodes := gu.mutation.AuthUsersGroupsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   group.AuthUsersGroupsTable,
...
// AddAuthUsersGroupIDs adds the "auth_users_groups" edge to the UsersGroups entity by IDs.
func (guo *GroupUpdateOne) AddAuthUsersGroupIDs(ids ...int) *GroupUpdateOne {
	guo.mutation.AddAuthUsersGroupIDs(ids...)
	return guo
}

// AddAuthUsersGroups adds the "auth_users_groups" edges to the UsersGroups entity.
func (guo *GroupUpdateOne) AddAuthUsersGroups(u ...*UsersGroups) *GroupUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return guo.AddAuthUsersGroupIDs(ids...)
}
...
// ClearAuthUsersGroups clears all "auth_users_groups" edges to the UsersGroups entity.
func (guo *GroupUpdateOne) ClearAuthUsersGroups() *GroupUpdateOne {
	guo.mutation.ClearAuthUsersGroups()
	return guo
}

// RemoveAuthUsersGroupIDs removes the "auth_users_groups" edge to UsersGroups entities by IDs.
func (guo *GroupUpdateOne) RemoveAuthUsersGroupIDs(ids ...int) *GroupUpdateOne {
	guo.mutation.RemoveAuthUsersGroupIDs(ids...)
	return guo
}

// RemoveAuthUsersGroups removes "auth_users_groups" edges to UsersGroups entities.
func (guo *GroupUpdateOne) RemoveAuthUsersGroups(u ...*UsersGroups) *GroupUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return guo.RemoveAuthUsersGroupIDs(ids...)
}
...
func (guo *GroupUpdateOne) sqlSave(ctx context.Context) (_node *Group, err error) {
	...
	if guo.mutation.UsersCleared() {
		...
		createE := &UsersGroupsCreate{config: guo.config, mutation: newUsersGroupsMutation(guo.config, OpCreate)}
		createE.defaults()
		_, specE := createE.createSpec()
		edge.Target.Fields = specE.Fields
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	...
	if guo.mutation.AuthUsersGroupsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   group.AuthUsersGroupsTable,
	...
	if nodes := guo.mutation.RemovedAuthUsersGroupsIDs(); len(nodes) > 0 && !guo.mutation.AuthUsersGroupsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   group.AuthUsersGroupsTable,
	...
	if nodes := guo.mutation.AuthUsersGroupsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   group.AuthUsersGroupsTable,
