...
// was not loaded in eager-loading.
func (e RoleEdges) AuthUsersRolesOrErr() ([]*UsersRoles, error) {
	if e.loadedTypes[1] {
...
// QueryAuthUsersRoles queries the "auth_users_roles" edge of the Role entity.
func (r *Role) QueryAuthUsersRoles() *UsersRolesQuery {
	return NewRoleClient(r.config).QueryAuthUsersRoles(r)
}
