...
func (rq *RoleQuery) QueryAuthUsersRoles() *UsersRolesQuery {
	query := (&UsersRolesClient{config: rq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := rq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (rq *RoleQuery) Clone() *RoleQuery {
	...
	return &RoleQuery{
		...
		withAuthUsersRoles: rq.withAuthUsersRoles.Clone(),
...
func (rq *RoleQuery) WithAuthUsersRoles(opts ...func(*UsersRolesQuery)) *RoleQuery {
	query := (&UsersRolesClient{config: rq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	rq.withAuthUsersRoles = query
	return rq
}
...
func (rq *RoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Role, error) {
	...
	if query := rq.withAuthUsersRoles; query != nil {
		if err := rq.loadAuthUsersRoles(ctx, query, nodes,
			func(n *Role) { n.Edges.AuthUsersRoles = []*UsersRoles{} },
			func(n *Role, e *UsersRoles) { n.Edges.AuthUsersRoles = append(n.Edges.AuthUsersRoles, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (rq *RoleQuery) loadAuthUsersRoles(ctx context.Context, query *UsersRolesQuery, nodes []*Role, init func(*Role), assign func(*Role, *UsersRoles)) error {
	...
	query.Where(predicate.UsersRoles(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(role.AuthUsersRolesColumn), fks...))
	}))
